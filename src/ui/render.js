...
function setupGuidePreview(state){
  ...
  const primary=step===1&&!connected?`<button type="button" class="setup-demo-primary" data-action="setup-demo-connect">Discord 연결 체험</button>`:needsGeneration?`<button type="button" class="setup-demo-primary setup-demo-primary--generate" data-action="setup-demo-generate-channels">이 구성으로 생성 체험</button>`:step===5?`<button type="button" class="setup-demo-primary" data-action="setup-demo-finish">체험 종료</button>`:`<button type="button" class="setup-demo-primary" data-action="setup-demo-next">${nextLabel}</button>`;
