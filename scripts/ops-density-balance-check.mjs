...
const checks=[
  ...
  ['account table adds useful Discord identity column',render.includes('<span>이름</span><span>Discord</span><span>역할</span><span>계좌번호</span><span>상태</span><span>관리</span>')],
  ['asset search includes surfaced memo',render.includes("${a.note||''}")&&render.includes("toLowerCase().includes(q)")],
  ['member columns use balanced fractional distribution',mgmt.includes('minmax(0,1.08fr) minmax(0,1.08fr) minmax(0,.72fr) minmax(0,.86fr) minmax(0,.72fr) minmax(0,.58fr)')],
  ...
  ['account columns use balanced fractional distribution',mgmt.includes('minmax(0,.95fr) minmax(0,1fr) minmax(0,.70fr) minmax(0,1.28fr) minmax(0,.72fr) minmax(0,.58fr)')],
