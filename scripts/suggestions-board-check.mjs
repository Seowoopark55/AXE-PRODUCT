...
const files={
  ...
  sql:read('SUPABASE_MIGRATION_3_25_0_PRIVATE_SUGGESTION_BOARD.sql'),
...
expect('Discord is notification-only and linked id is automatic', files.notify.includes('AXE PRODUCT 건의에 답변이 등록되었습니다.') && files.sql.includes('discord_user_id') && !files.render.includes('name="contact"'));
