...
const checks=[
  ['three recommended categories exist in UI', ['AXE ONE · 무법지대','AXE ONE · 회사운영','AXE ONE · 편의기능'].every(v=>render.includes(v))],
  ...
  ['recommended category order is explicit', api.includes("['AXE ONE · 무법지대', 'AXE ONE · 회사운영', 'AXE ONE · 편의기능']")],
  ['outlaw cluster order keeps pinball before record', main.indexOf("key:'pinball'") < main.indexOf("key:'outlaw'")],
  ['legacy single-category payload remains supported', api.includes("cleanName(req.body?.category_name, 'AXE ONE')")],
