...
expect('Fund semantic ledger table structure', render.includes('axe-fund-ledger-table') && render.includes('<thead><tr>') && render.includes('<tr class="axe-fund-ledger-row">') && render.includes('renderLedgerRow(r,state)'));
