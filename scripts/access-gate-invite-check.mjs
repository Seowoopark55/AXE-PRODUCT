...
const checks=[
  ...
  ['unaffiliated access gate',render.includes('COMPANY ACCESS REQUIRED')&&render.includes('data-form="invite-redeem"')],
  ...
  ['minimal privacy copy is conditional',render.includes('state.discordAuthMinimal')&&render.includes('이메일 권한 요청 없음')],
