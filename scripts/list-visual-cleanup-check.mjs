...
const checks=[
  ['web package version',pkg.version==='1.7.41-web-ui.78'],
  ...
  ['accounts expose role as a dedicated column',render.includes('<span>이름</span><span>Discord</span><span>역할</span><span>계좌번호</span><span>상태</span><span>관리</span>')],
