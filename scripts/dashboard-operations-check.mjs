...
expect('3.22.0 web package version',pkg.version==='1.7.41-web-ui.46');
expect('dashboard is a valid route',main.includes("const validPages = ['dashboard','fund','members','assets','accounts','settings','guide','platform']"));
