...
expect('current web package version',pkg.version==='1.7.41-web-ui.55');
expect('dashboard is a valid route',main.includes("const validPages = ['dashboard','fund','members','assets','accounts','questions','settings','platform']"));
