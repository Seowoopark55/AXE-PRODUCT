...
const checks=[
  ...
  ['fund semantic table board',render.includes('axe-fund-ledger-table')&&render.includes('<tr class="axe-fund-ledger-row">')&&fund.includes('.axe-fund-ledger-table{')],
  ['fund semantic table is intentionally isolated',render.includes('axe-fund-ledger-table')&&!render.includes('ops-data-table')],
