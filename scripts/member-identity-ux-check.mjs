...
check(html.includes('<title>LAC ONE</title>')&&!html.includes('<title>LAC ONE STAGING</title>'),'browser title is customer-facing');
...
if(!process.exitCode) console.log('LAC ONE MEMBER IDENTITY UX CHECK: PASS');
