...
const checks=[
  ['shared page-size contract',/OPS_PAGE_SIZE=\{questions:5,suggestions:5,fund:8,fundReview:6,members:8,assets:8,returns:8,accounts:8,cooking:9,platform:8\}/.test(render)],
