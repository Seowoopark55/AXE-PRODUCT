...
const checks=[
  ['shared page-size contract',/OPS_PAGE_SIZE=\{questions:6,fund:8,members:8,assets:8,returns:8,accounts:8,cooking:9\}/.test(render)],
  ...
  ['questions status filter pager',render.includes('data-action="question-filter"')&&render.includes("renderDataPager('questions'")],
  ...
  ['question scale styling',pages.includes('Question board bounded list')],
];
let failed=0;
