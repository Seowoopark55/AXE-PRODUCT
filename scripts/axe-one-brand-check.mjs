...
if(!render.includes('<strong>LAC HUB</strong>')) failures.push('app shell brand is not LAC HUB');
if(!main.includes('LAC HUB 멤버 등록 요청')) failures.push('registration copy is not LAC HUB');
