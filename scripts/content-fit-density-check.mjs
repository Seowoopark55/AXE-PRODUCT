...
const checks=[
  ...
  ['member lanes include role column', management, /grid-template-columns:minmax\(120px,1\.45fr\) 74px 94px 70px 52px/],
  ['asset lanes include acquisition column', management, /grid-template-columns:86px minmax\(110px,1\.35fr\) 82px 68px 70px 52px/],
  ['account lanes include role column', management, /grid-template-columns:minmax\(108px,1fr\) 70px minmax\(145px,1\.25fr\) 70px 52px/],
