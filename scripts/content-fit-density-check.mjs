...
const checks=[
  ...
  ['member lanes include role column', management, /grid-template-columns:minmax\(0,1\.08fr\) minmax\(0,1\.08fr\) minmax\(0,\.72fr\) minmax\(0,\.86fr\) minmax\(0,\.72fr\) minmax\(0,\.58fr\)/],
  ...
  ['account lanes include role column', management, /grid-template-columns:minmax\(0,\.95fr\) minmax\(0,1fr\) minmax\(0,\.70fr\) minmax\(0,1\.28fr\) minmax\(0,\.72fr\) minmax\(0,\.58fr\)/],
