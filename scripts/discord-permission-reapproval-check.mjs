...
ok('reapproval uses shared least-privilege baseline', reapprove.includes('DISCORD_BOT_BASE_PERMISSIONS') && security.includes("DISCORD_BOT_BASE_PERMISSIONS = '17179962384'") && security.includes("'MANAGE_THREADS'"));
