...
expect('member path is blocked until company-side registration',render.includes('등록되기 전에는 LAC HUB에 진입할 수 없습니다.'));
...
expect('member path shows and copies Discord registration identity',render.includes('Discord ID')&&render.includes("const copyAction=testMode?'test-center-copy-info':'copy-registration-info'")&&main.includes('LAC HUB 멤버 등록 요청'));
