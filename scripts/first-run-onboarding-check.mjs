...
expect('current package version',pkg.version==='1.7.41-web-ui.68');
...
expect('member path is blocked until company-side registration',render.includes('등록되기 전에는 AXE ONE에 진입할 수 없습니다.'));
