...
expect('first-run stays registration-gated with no company search/join code',render.includes('이미 이용 중인 회사의 팀원입니다')&&render.includes('등록되기 전에는 LAC ONE에 진입할 수 없습니다.')&&!render.includes('data-form="join-company"'));
