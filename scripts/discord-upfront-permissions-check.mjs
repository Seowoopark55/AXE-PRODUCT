...
ok('baseline permission bitfield is defined', security.includes("DISCORD_BOT_BASE_PERMISSIONS = '17179962384'"));
...
ok('guide lists channel and message permissions', render.includes('채널 보기') && render.includes('메시지 전송') && render.includes('임베드 표시') && render.includes('메시지 기록 보기') && render.includes('메시지 관리') && render.includes('채널 관리') && render.includes('스레드 관리'));
