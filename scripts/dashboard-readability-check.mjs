...
expect('current web package version',pkg.version==='1.7.41-web-ui.71');
...
expect('metric values remain prominent',css.includes('.axe-dashboard-metrics strong{color:#f0ece4;font-size:19px'));
expect('metric helper text removed',!css.includes('.axe-dashboard-metrics small{'));
...
expect('quick action title remains prominent',css.includes('color:#e4e7ea;font-size:12px'));
expect('quick action helper text removed',!css.includes('.axe-dashboard-quick-grid small{'));
...
expect('system connection helper removed',!css.includes('.axe-dashboard-system-line .connection-status small{'));
