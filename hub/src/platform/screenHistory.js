...
const SCREENS = new Set(['hub', 'hub-board', 'company-start', 'dashboard', 'fund', 'members', 'assets', 'accounts', 'questions', 'suggestions', 'settings', 'info', 'combat', 'game-info', 'platform', 'layout']);
