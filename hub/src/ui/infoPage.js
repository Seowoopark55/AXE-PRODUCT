...
export function renderInfoPage(state,{standalone=false}={}){
 ...
 const heroEyebrow=selected&&standalone&&table==='info_quests'?'':selected&&['info_processes','info_quests'].includes(table)?String(selected.job||'').trim():selected?CONFIG[table][0]:'';
