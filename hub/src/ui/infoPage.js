...
// Read-only image mapping from the verified game-info export and approved WebP asset set.
// Only known names are mapped. Do not infer a PNG from item names, IDs or category.
const ITEM_IMAGE_FILES=Object.freeze({
  ".44 매그넘 탄약": "ammo_44_magnum.webp",
  ".45 ACP 탄약": "ammo_45_acp.webp",
  ".50 AE 탄약": "ammo_50_ae.webp",
  "9mm 탄약": "ammo_9mm.webp",
  "SMG": "smg.webp",
  "SNS 피스톨": "sns_pistol.webp",
  "견습생의 도구": "apprentice_tool.webp",
  "견승생의 도구": "apprentice_tool.webp",
  "고급 삼나무": "premium_cedar.webp",
  "고철": "scrap_metal.webp",
  "금 주괴": "gold_ingot.webp",
  "금광석": "gold_ore.webp",
  "금주괴": "gold_ingot.webp",
  "기본 감정 키트(1)": "basic_appraisal_kit.webp",
  "기본 감정 키트(2)": "basic_appraisal_kit.webp",
  "나이프": "knife.webp",
  "낡은 락픽": "old_lockpick.webp",
  "녹슨 탄피": "rusted_casing.webp",
  "달인의 도구": "master_tool.webp",
  "동광석": "copper_ore.webp",
  "동주괴": "copper_ingot.webp",
  "마이크로 SMG": "micro_smg.webp",
  "목탄": "charcoal.webp",
  "무난한 무기부품": "standard_weapon_parts.webp",
  "미니 SMG": "mini_smg.webp",
  "배송 전표": "shipping_label.webp",
  "버려진 병뚜껑": "discarded_bottle_cap.webp",
  "볼품없는 락픽": "crude_lockpick.webp",
  "상급 목재": "premium_wood.webp",
  "상급목재": "premium_wood.webp",
  "석탄": "coal.webp",
  "세라믹 피스톨": "ceramic_pistol.webp",
  "소형 탄피": "small_casing.webp",
  "소형 탄피(20)": "small_casing.webp",
  "숙련가의 도구": "expert_tool.webp",
  "오래된 나사": "old_screw.webp",
  "유황": "sulfur.webp",
  "은광석": "silver_ore.webp",
  "은주괴": "silver_ingot.webp",
  "의료용 붕대": "medical_bandage.webp",
  "이단 산타의 리볼버": "heretic_santa_revolver.webp",
  "일반 삼나무": "common_cedar.webp",
  "저급 삼나무": "low_grade_cedar.webp",
  "전문가의 도구": "professional_tool.webp",
  "조악한 무기부품": "crude_weapon_parts.webp",
  "종이": "paper.webp",
  "중급 목재": "medium_grade_wood.webp",
  "중급목재": "medium_grade_wood.webp",
  "찢어진 천조각": "torn_cloth.webp",
  "철광석": "iron_ore.webp",
  "철주괴": "iron_ingot.webp",
  "초심자의 도구": "beginner_tool.webp",
  "최상급 목재": "top_grade_wood.webp",
  "최상급 삼나무": "top_grade_cedar.webp",
  "최상급목재": "top_grade_wood.webp",
  "캠프 파이어 키트(1)": "quick_campfire_kit.webp",
  "캠프 파이어 키트(2)": "quick_campfire_kit.webp",
  "캠프 파이어 키트(3)": "quick_campfire_kit.webp",
  "컴뱃 PDW": "combat_pdw.webp",
  "컴뱃 피스톨": "combat_pistol.webp",
  "폭죽 시리즈 I": "firework_series_1.webp",
  "플로우 생수": "flow_water.webp",
  "피스톨": "pistol.webp",
  "피스톨.50": "pistol_50.webp",
  "하급목재": "low_grade_wood.webp",
  "헤비 리볼버": "heavy_revolver.webp",
  "헤비 피스톨": "heavy_pistol.webp",
  "화약": "gunpowder.webp",
  "셰프의 야생 블루베리": "quest_wild_blueberry.webp",
  "야생 블루베리": "quest_wild_blueberry.webp",
  "삼나무 베리": "quest_cedar_berry.webp",
  "암염": "quest_rock_salt.webp",
  "산딸기": "quest_raspberry.webp",
  "홀리리프 체리": "quest_hollyleaf_cherry.webp",
  "솔리리프 베리": "quest_hollyleaf_cherry.webp",
  "삼나무 솔방울": "quest_cedar_cone.webp",
  "평범한 잎사귀": "quest_plain_leaf.webp",
  "네잎클로버": "quest_four_leaf_clover.webp",
  "느타리 버섯": "quest_oyster_mushroom.webp",
  "광대 버섯": "quest_fly_agaric.webp",
  "큰갓 버섯": "quest_big_cap_mushroom.webp",
  "식물줄기": "quest_plant_stem.webp",
  "그물버섯": "quest_net_mushroom.webp",
  "모빌버섯": "quest_mobil_mushroom.webp",
  "달빛잎사귀": "quest_moonlight_leaf.webp",
  "반짝이는 보석": "quest_shining_gem.webp",
});
...
const QUEST_JOB_FALLBACK_FILES=Object.freeze({
 '벌목':'quest_logging_bundle.webp',
 '채광':'quest_mining_sack.webp',
 '배송':'quest_delivery_box.webp',
 '택배':'quest_delivery_box.webp',
 '낚시':'quest_fishing_crate.webp',
 '요리':'quest_cooking_meal.webp',
 '셰프':'quest_cooking_meal.webp',
 '채집':'quest_herb_basket.webp',
 '할머니':'quest_tactical_clipboard.webp',
 '감정':'quest_tactical_clipboard.webp',
 '미션':'quest_tactical_clipboard.webp',
 '기타':'quest_tactical_clipboard.webp',
 '범용':'quest_tactical_clipboard.webp',
});
...
const questKeywordFallbackFile=name=>{
 ...
 if(/(베리|허브|약초|꽃|버섯)/.test(clean))return 'quest_herb_basket.webp';
 if(/(광석|원석|암염|석탄|주괴|광물)/.test(clean))return 'quest_mining_sack.webp';
 if(/(장작|통나무|목재|삼나무)/.test(clean))return 'quest_logging_bundle.webp';
 if(/(도시락|요리|음식|식사)/.test(clean))return 'quest_cooking_meal.webp';
 if(/(생선|어획|낚시)/.test(clean))return 'quest_fishing_crate.webp';
 if(/(상자|배송|택배)/.test(clean))return 'quest_delivery_box.webp';
 return '';
};
...
const QUEST_BONUS_REWARD_ART=Object.freeze({
 '삼나무 솔방울':[{label:'보따리',file:'quest_logging_bundle.webp'}],
 '반짝이는 보석':[{label:'상자',file:'quest_delivery_box.webp'}],
});
const questBonusRewards=row=>{
 ...
 const items=[];
 if(note.includes('보따리'))items.push({label:'보따리',file:'quest_logging_bundle.webp'});
 if(note.includes('상자'))items.push({label:'상자',file:'quest_delivery_box.webp'});
 return items;
};
...
export function searchInformation(data,query,info={},owner=false){
 ...
 for(const row of visibleRows(data,'modbook_catalog',info,owner)){
  ...
  if(!matchText([row.name,row.type,row.category,row.parts,row.option1,row.option2,row.option3],q))continue;
